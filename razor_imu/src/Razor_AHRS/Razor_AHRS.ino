...
float ACCEL_X_MIN = -273;
float ACCEL_X_MAX = 282;
float ACCEL_Y_MIN = -276;
float ACCEL_Y_MAX = 277;
float ACCEL_Z_MIN = -310;
float ACCEL_Z_MAX = 202;
...
float magn_ellipsoid_center[3] = {180.164, 74.3922, 68.5088};
float magn_ellipsoid_transform[3][3] = {{0.892735, -0.0107427, -0.0339768}, {-0.0107427, 0.888744, -0.00215294}, {-0.0339768, -0.00215294, 0.989223}};
 

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = -26.05;
float GYRO_AVERAGE_OFFSET_Y = -17.12;
float GYRO_AVERAGE_OFFSET_Z = -5.30;
